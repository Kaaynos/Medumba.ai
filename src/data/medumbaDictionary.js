...
export const MEDUMBA_QUESTIONS = {
  ...
  "l15": [
    { "sourceFr": "Bonjour / Salut", "sourceEn": "Hello / Hi", "answer": ["Ndà'ndà' lα!"],
      "bank": ["Ndà'ndà' lα!", "A fi tsə", "Mə làbtə̌", "Â ndʉ̂ kə?", "Ò bə α̂ wə?"], "audio": "Ndà'ndà' lα!" },
    { "sourceFr": "Comment ça va ?", "sourceEn": "How are you?", "answer": ["Â ndʉ̂ kə?"],
      "bank": ["Â ndʉ̂ kə?", "Ndà'ndà' lα!", "Lɛ̂n su bə α̂ wə?", "Mə làbtə̌", "A fi tsə"], "audio": "Â ndʉ̂ kə?" },
    { "sourceFr": "Ça va bien", "sourceEn": "I'm fine", "answer": ["A fi tsə"],
      "bank": ["A fi tsə", "Â ndʉ̂ kə?", "Ndà'ndà' lα!", "Mə làbtə̌", "Ò bə α̂ wə?"], "audio": "A fi tsə" },
    ...
    { "sourceFr": "Comment tu t'appelles ?", "sourceEn": "What is your name?", "answer": ["Lɛ̂n su bə α̂ wə?"],
      "bank": ["Lɛ̂n su bə α̂ wə?", "Ò bə α̂ wə?", "Â ndʉ̂ kə?", "Ndà'ndà' lα!", "A fi tsə"], "audio": "Lɛ̂n su bə α̂ wə?" },
    { "sourceFr": "Mon nom est…", "sourceEn": "My name is…", "answer": ["Lɛ̂n sαm bə α̂…"],
      "bank": ["Lɛ̂n sαm bə α̂…", "Lɛ̂n su bə α̂ wə?", "Mə làbtə̌", "A fi tsə", "Â ndʉ̂ kə?"], "audio": "Lɛ̂n sαm bə α̂…" },
    { "sourceFr": "Qui es-tu ?", "sourceEn": "Who are you?", "answer": ["Ò bə α̂ wə?"],
      "bank": ["Ò bə α̂ wə?", "Lɛ̂n su bə α̂ wə?", "Â ndʉ̂ kə?", "A fi tsə", "Ndà'ndà' lα!"], "audio": "Ò bə α̂ wə?" },
    { "sourceFr": "Oui", "sourceEn": "Yes", "answer": ["Ŋ"],
      "bank": ["Ŋ", "Ngα", "A fi tsə", "Mə làbtə̌", "Ò bə α̂ wə?"], "audio": "Ŋ" },
    { "sourceFr": "Non", "sourceEn": "No", "answer": ["Ngα"],
      "bank": ["Ngα", "Ŋ", "A fi tsə", "Mə làbtə̌", "Â ndʉ̂ kə?"], "audio": "Ngα" },
    { "sourceFr": "Et toi ?", "sourceEn": "And you?", "answer": ["Wʉ̌ yò ghò?"],
      "bank": ["Wʉ̌ yò ghò?", "Ò bə α̂ wə?", "Â ndʉ̂ kə?", "A fi tsə", "Mə làbtə̌"], "audio": "Wʉ̌ yò ghò?" },
    { "sourceFr": "Je suis en bonne santé", "sourceEn": "I am healthy", "answer": ["Mə tswə ntʉ̀n"],
      "bank": ["Mə tswə ntʉ̀n", "A fi tsə", "Mə làbtə̌", "Â ndʉ̂ kə?", "Ò bə α̂ wə?"], "audio": "Mə tswə ntʉ̀n" },
  ...
  l15: {
    meaning: [
      { type: 'meaning', sourceFr: 'Bonjour / Salut', sourceEn: 'Hello', audio: 'Ndà\'ndà\' lα!',
        options: ['Ndà\'ndà\' lα!', 'A fi tsə', 'Mə làbtə̌', 'Â ndʉ̂ kə?'],
        optionsFr: ['Ndà\'ndà\' lα!', 'A fi tsə', 'Mə làbtə̌', 'Â ndʉ̂ kə?'],
        answer: 'Ndà\'ndà\' lα!', answerFr: 'Ndà\'ndà\' lα!' },
      { type: 'meaning', sourceFr: 'Ça va bien', sourceEn: 'I\'m fine', audio: 'A fi tsə',
        options: ['A fi tsə', 'Â ndʉ̂ kə?', 'Mə làbtə̌', 'Ò bə α̂ wə?'],
        optionsFr: ['A fi tsə', 'Â ndʉ̂ kə?', 'Mə làbtə̌', 'Ò bə α̂ wə?'],
      ...
      { type: 'meaning', sourceFr: 'Comment ça va ?', sourceEn: 'How are you?', audio: 'Â ndʉ̂ kə?',
        options: ['Â ndʉ̂ kə?', 'Ò bə α̂ wə?', 'A fi tsə', 'Lɛ̂n su bə α̂ wə?'],
        optionsFr: ['Â ndʉ̂ kə?', 'Ò bə α̂ wə?', 'A fi tsə', 'Lɛ̂n su bə α̂ wə?'],
        answer: 'Â ndʉ̂ kə?', answerFr: 'Â ndʉ̂ kə?' },
      ...
      { type: 'meaning', sourceFr: 'Non', sourceEn: 'No', audio: 'Ngα',
        options: ['Ngα', 'Ŋ', 'A fi tsə', 'Â ndʉ̂ kə?'],
        optionsFr: ['Ngα', 'Ŋ', 'A fi tsə', 'Â ndʉ̂ kə?'],
    ...
    match: [{ type: 'match', pairs: [
      ...
      { medumba: 'Â ndʉ̂ kə?',       french: 'Comment ça va?', english: 'How are you?' },
